...
class Connection(metaclass=ConnectionMeta):
    ...
    async def executemany(self, command: str, args, *, timeout: float = ...):
        ...
        ...
    def cursor(
        self, query, *args, prefetch=..., timeout=..., record_class=...
    ):  # -> CursorFactory:
        ...
        ...
    async def prepare(
        self, query, *, name=..., timeout=..., record_class=...
    ):  # -> PreparedStatement:
    ...
    async def set_type_codec(
        self, typename, *, schema=..., encoder, decoder, format=...
    ):  # -> None:
    ...
    async def set_builtin_type_codec(
        self, typename, *, schema=..., codec_name, format=...
    ):  # -> None:
