...
class PoolConnectionProxyMeta(type):
    def __new__(mcls, name, bases, dct, *, wrap=...): # -> Self@PoolConnectionProxyMeta:
        ...
...
class Pool:
    ...
    def get_idle_size(self): # -> Literal[0]:
    ...
    def __await__(self): # -> Generator[Any, None, Self@Pool | None]:
        ...
